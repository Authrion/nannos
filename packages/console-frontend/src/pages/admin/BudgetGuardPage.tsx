...
// The USD fields arrive as Decimal-serialized strings (e.g. "12.5"), so coerce before
// formatting — String.prototype.toLocaleString silently ignores the currency options.
